...
// Approximate land-area bounding box for Istanbul.
// Used to limit Photon results and keep search UX fast.
const ISTANBUL_BBOX = { west: 28.60, south: 40.80, east: 29.45, north: 41.30 };
...
export async function geocode(query: string): Promise<GeoResult[]> {
  ...
  const params = new URLSearchParams({
    q: query,
    bbox: `${ISTANBUL_BBOX.west},${ISTANBUL_BBOX.south},${ISTANBUL_BBOX.east},${ISTANBUL_BBOX.north}`,
    limit: "5",
    lang: "en",
    lat: "41.0082",
    lon: "28.9784",
